...
![Interactions API response](<다운로드 (1).png>)
...
![Web Quill drawing interface](<다운로드 (2).png>)
...
![WebSocket OCR response](<다운로드 (3).png>)
...
![Flag in proc self environ](<다운로드 (4).png>)
...
![Prototype pollution payload import](<다운로드 (5).png>)

→ PP 페이로드 삽입

![Prototype pollution verification response](<다운로드 (6).png>)
...
![Nested where payload example](<다운로드 (7).png>)
